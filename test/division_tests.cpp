...
namespace ralg {
  ...
  TEST_CASE("Polynomial division") {
    ...
    // polynomial g1{{{1.0, {1, 1}, 2}, {1.0, {1, 0}, 2}}, 2};
    // polynomial g2{{{1.0, {2, 0}, 2}, {1.0, {0, 0}, 2}}, 2};

    // polynomial a1{{{1.0, {1, 0}, 2}}, 2};
    // polynomial a2{{{-1.0, {0, 0}, 2}}, 2};
    // polynomial r{{{-1.0, {0, 1}, 2}, {-1.0, {0, 0}, 2}}, 2};
